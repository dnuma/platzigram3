...
SECRET_KEY = '@o28pq$r=bmihvpm1=_t08w9)ry!a#$%5!ufo=i5(ar-qm8fh!'
...
MIDDLEWARE = [
    ...
    'platzigram.middleware.ProfileCompletionMiddleware',        #platzigram/middleware.py
]
...
#ruta de las media sería en el path actualizar, es convención
